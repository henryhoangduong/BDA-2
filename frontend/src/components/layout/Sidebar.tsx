...
export function Sidebar() {
  ...
  return (
    ...
    >
        ...
        {expanded ? (
          <>
            <div className="flex items-center">
              <span className="text-xl font-semibold">LA</span>
      ...
      <div
        className={cn(
          "space-y-1 border-t border-gray-200 pt-3 mt-auto",
          expanded ? "px-3" : "px-2"
        )}
      >
      ...
      <div
        className={cn(
          "pt-3 border-t border-gray-200 mt-2",
          expanded ? "px-3" : "px-2"
        )}
      >
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              {expanded && (
                <div className="flex flex-col items-start text-sm ml-2 min-w-0">
                  <span className="font-medium break-all">
                    {user?.email ? user.email.split("@")[0] : "User"}
                  </span>
                  <span className="text-xs text-gray-500 truncate overflow-hidden text-ellipsis whitespace-nowrap w-full">
